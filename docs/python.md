# Some Automation Code with Pyton

### Code Snippet 1

The python code below represents a culmination of putting together various python concepts. With this code I demonstrate some basic level of automation using python to analyze data from a theorotical SIEM tool. 
...
This python code represents an introduction to using regular expressions to find targeted information. The script here uses a pattern to detect IP addresses that are then iterated through and conditional messages for those discovered patterns as output.
